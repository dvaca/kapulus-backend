...
app.get('/asistente/:idevento', (req, res, next) => {
  ...
  app.post('/correo/:idevento', (req, res, next) => {
	...
	if(req.body.tipo == 0){
      ...
      adjuntos = [
        {
          path:"./resources/QR_diabetes_header.png",  
          filename:"QR_diabetes_header.png",  
          cid: "confirmacionheader"
        },
		{
          path:"./resources/QR_diabetes_footer.png",  
          filename:"QR_diabetes_footer.png",  
          cid: "confirmacionfooter"
        },
        {
          filename: "QR.png",
      ...
      adjuntos = [
        {
          path:"./resources/HeaderFutureWhitePartyBVC.png",  
          filename:"HeaderFutureWhitePartyBVC.png",  
          cid: "confirmacionheader"
        },
		{
          path:"./resources/FooterFutureWhitePartyBVC.png",  
          filename:"FooterFutureWhitePartyBVC.png",  
          cid: "confirmacionfooter"
        },
        {
          filename: "QR.png",
      ...
      adjuntos = [
        {
          path:"./resources/headerVanti.png",  
          filename:"headerVanti.png",  
          cid: "confirmacionheader"
        },
        {
          filename: "QR.png",
      ...
      adjuntos = [
        {
          path:"./resources/invitacionAmarilo.jpg",  
          filename:"invitacionAmarilo.jpg",  
          cid: "invitacion"
        }
      ]
	  }
